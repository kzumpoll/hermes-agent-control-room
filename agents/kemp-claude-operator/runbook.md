# kemp-claude-operator — Runbook

## "Bot not responding"
1. `boxd exec kemp-claude-operator -- tmux ls` — cc session?
2. `boxd exec kemp-claude-operator -- tmux capture-pane -t cc -p -S -30` — visible state?
